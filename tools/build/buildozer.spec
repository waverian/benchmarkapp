...
# (str) Package name
package.name = evobench3

# (str) Package domain (needed for android/ios packaging)
package.domain = com.yourcompany

# (str) Source code where the main.py live
source.dir = ../../benchmarkapp

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,ttf,mp3,mo,json,atlas,txt,html
...
source.exclude_dirs = tests, bin, venv, default
...
# version is to be provided via APP_VERSION env. variable
...
requirements = kivy==2.3.1,
    ...
    docutils==0.21.2,
    sentry_sdk==1.17.0,
    libevolution-benchmark==3.3.1,
    pyevolution-benchmark==3.3.1,
    androidstorage4kivy,
    urllib3==1.26.10,
    app
...
# (str) # Valid options are: landscape, portrait, portrait-reverse or landscape-reverse
orientation = portrait, landscape

# (list) List of service to declare
services = mediaserver:./service/main.py:foreground
...
android.presplash_color = #004279
...
android.logcat_filters = *:S python,benchmark,SDL:D
...
# (str) python-for-android URL to use for checkout, defaults to upstream (https://github.com/kivy/python-for-android.git)
#p4a.url = 
...
p4a.local_recipes = ../../build/android/recipes/
...
ios.camera_usage_description = We include frameworks that have capability to use camers,  Camera is actually not used.

# ------------------------------------------------------------------------------
[app@android]

# (str) Source code where the main.py live
source.dir = ../../build/android/src
...
[app@ios_local]
# (str) Package name
package.name = benchmarktest
source.dir = ../../benchmarkapp

# (str) Package domain (needed for android/ios packaging)
package.domain = com.benchtest
